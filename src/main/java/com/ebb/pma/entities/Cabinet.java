 ...
 * Purpose: Defines the Class Cabinet
 ***********************************************************************/
...
@Entity
/** @pdOid bf7995f5-7c61-450e-9ed7-013048e45b9c */
public class Cabinet extends Structure {
   /** @pdOid 1433ec4b-7014-4efe-a789-664d69394466 */
   private String type;
   
   /** @pdRoleInfo migr=no name=Ordonnance assc=cabinetOrdonnance coll=java.util.Collection impl=java.util.HashSet mult=0..* */
